...
You are a Principal Software Architect, Senior Full-Stack MERN Engineer, and AI Product Designer.
Your task is to DESIGN and GENERATE a COMPLETE, PRODUCTION-READY MERN STACK WEB APPLICATION.
...
- AI-powered one-paste job posting:
  Admin pastes raw job text or link → system auto-fills:
    - Company
    - Role
    - Eligibility
    - Batch
...
6) Sample .env files
7) README with setup & deployment steps
